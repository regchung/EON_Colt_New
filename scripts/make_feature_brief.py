#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""產生「DrFish 功能簡介」PDF(給車隊客戶/主管,商業白話、賣點導向)。
...
OUT = "/Users/ycchfx/AI實作/DR_FISH/DR_FISH_功能簡介.pdf"
...
P("DrFish 智慧派遣系統 · 功能簡介。效益數字取自真實營運回算,供評估參考。", note)
