#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""產生 DrFish 人工 vs 自動 對比報告 PDF(中文)。"""
import json
...
doc = SimpleDocTemplate("/Users/ycchfx/AI實作/DR_FISH/DR_FISH_對比報告.pdf",
                        pagesize=A4, topMargin=18*mm, bottomMargin=16*mm,
                        leftMargin=18*mm, rightMargin=18*mm,
                        title="DrFish 人工 vs 自動 對比報告")
story = []
...
P("本報告由 DrFish 系統自動產生。資料來源:小驢駒集團長照派遣歷史(已去識別化)。", small)

doc.build(story)
print("PDF 已產生:/Users/ycchfx/AI實作/DR_FISH/DR_FISH_對比報告.pdf")
