...
migration 已到 `0025`;表:vehicles / drivers / orders / address_point / address_alias / route_stop / users
...
規劃/原則文件見 `docs/dispatch-principles.md`(派遣原則)、`docs/effectiveness-2026-06-22.md`(效益)、
...
> **最新全量對比(2025-03~2026-01,556 車行-日、36,163 趟,全部派遣原則更新後)**:
> 人工 **7,328 → 自動 5,960 車日(↓18.7%)**,省 1,368 車日 ≈ NT$520 萬/期間(年化 ~585 萬);
> **556 天中自動 472 更省、84 打平、0 落敗**(從不輸人工)。未派 12(多服務時段外)。詳見 `docs/effectiveness-2026-06-22.md`。
> (早期 220 日子集為 2,920→2,384、↓18.4%;演進:預設座位/自由共乘/無工時約束時 ↓47–51%,屬理論上限。)
