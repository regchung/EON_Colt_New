...
migration 已到 `0011`;表:vehicles / drivers / orders / address_point / address_alias / route_stop / users
...
> 對比成果(220 營運日、13,534 趟真實單):集團用車 2,920→1,543 車日(↓47.2%),191/220 天自動更省。
