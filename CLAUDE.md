...
3. **🟠 共乘推薦 P2/P3(P1 已完成)**:P1 雙跑 VROOM 產生名單+效益(實測:推薦組全同意可較現況再 ↓9.4%,
   即 vs 人工 ↓18.4%→↓26%,僅需徵詢 134 組/268 趟)。P2 已完成:`/dispatch/pool-consent` 同意捕捉
   (留痕 by/at)+ 前端一鍵「標記同意並重算」。P3 常態共乘對已完成(`/dispatch/pool-recurring`,
   實測 57 組反覆同行 ≥3 日、最高 26 日)。**剩餘**:徵詢成功率學習(需先有真實徵詢結果資料,
   目前 pool-consent 已留痕同意/撤回,可累積後再做)。
